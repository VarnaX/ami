...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --daemon=true --disk-cache=2048M --enable-rpc=true --follow-torrent=mem --force-save=true --http-accept-gzip=true \
       --max-connection-per-server=16 --max-concurrent-downloads=5 --max-file-not-found=0 --max-tries=20 \
